...
python models/train_sweep.py --config results/thesis_model_results/configs/relu_size_mlp_picnn.yaml
python models/train_sweep.py --config results/thesis_model_results/configs/relu_size_mtlgsh.yaml
