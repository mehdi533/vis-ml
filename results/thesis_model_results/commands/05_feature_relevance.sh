...
python models/train_sweep.py --config results/thesis_model_results/configs/feature_relevance_attention.yaml
python models/train_sweep.py --config results/thesis_model_results/configs/shortlist_detailed_eval.yaml

python models/feature_relevance.py \
  --config results/thesis_model_results/configs/feature_relevance_attention.yaml \
  --model-dir results/thesis_model_results/outputs/feature_relevance_attention/MTLGSH_ATT__mse__minmax__seed42 \
  --mode both \
  --group-config results/thesis_model_results/configs/feature_groups.yaml

python models/feature_relevance.py \
  --config results/thesis_model_results/configs/shortlist_detailed_eval.yaml \
