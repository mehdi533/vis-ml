...
sbatch results/thesis_model_results/commands/07_mtlsh_embeddability_tradeoff.sh
sbatch results/thesis_model_results/commands/08_mlp_she_style_comparison.sh
