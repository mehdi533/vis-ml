...
python models/train_sweep.py --config results/thesis_model_results/configs/loss_comparison_mlp.yaml
python models/train_sweep.py --config results/thesis_model_results/configs/loss_comparison_mtlsh.yaml
python models/train_sweep.py --config results/thesis_model_results/configs/loss_comparison_mtlgsh.yaml
python models/train_sweep.py --config results/thesis_model_results/configs/loss_comparison_picnn.yaml
