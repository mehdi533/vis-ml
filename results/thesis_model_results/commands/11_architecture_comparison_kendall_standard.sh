...
python models/train_sweep.py --config results/thesis_model_results/configs/architecture_comparison_core_kendall_standard.yaml
python models/train_sweep.py --config results/thesis_model_results/configs/architecture_comparison_exploratory_kendall_standard.yaml
