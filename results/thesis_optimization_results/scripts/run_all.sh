...
FORMULATION_SUITE_CONFIG="${FORMULATION_SUITE_CONFIG:-results/thesis_optimization_results/configs/suites/01_formulation_comparison.yaml}"
SHE_SUITE_CONFIG="${SHE_SUITE_CONFIG:-results/thesis_optimization_results/configs/suites/02_she_vis_rted_style_comparison.yaml}"
AREA_VIS_SUITE_CONFIG="${AREA_VIS_SUITE_CONFIG:-results/thesis_optimization_results/configs/suites/03_area_vis_comparison.yaml}"
...
ZONE_MISMATCH_SUITE_CONFIG="${ZONE_MISMATCH_SUITE_CONFIG:-results/thesis_optimization_results/configs/suites/04_zone_mismatch_vis_sensitivity.yaml}"
...
SECURITY_SUITE_CONFIG="${SECURITY_SUITE_CONFIG:-results/thesis_optimization_results/configs/suites/05_security_checks.yaml}"
REDISPATCH_SUITE_CONFIG="${REDISPATCH_SUITE_CONFIG:-results/thesis_optimization_results/configs/suites/06_redispatch_sensitivity.yaml}"
