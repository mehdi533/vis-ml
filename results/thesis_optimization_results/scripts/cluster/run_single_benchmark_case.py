...
def _build_replay_config(task_row: dict[str, str]) -> tuple[dict[str, Any], Path]:
    ...
    if contingency_type == "line_trip":
        ...
        contingency["line_dev"] = int(float(task_row["outage_id"]))
...
def main() -> None:
    ...
    parser.add_argument("--benchmark-config", default="results/thesis_optimization_results/configs/thesis_optimization_benchmark.yaml")
    parser.add_argument("--formulation-suite", default="results/thesis_optimization_results/configs/suites/01_formulation_comparison.yaml")
