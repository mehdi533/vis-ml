...
case "${MODEL_VARIANT}" in
  ...
  mtlsh_no_dispatch)
    ...
    BASE_CONFIG_SOURCE="${BASE_CONFIG_SOURCE:-results/thesis_optimization_results/configs/base_optimization_mtlsh_no_dispatch.yaml}"
    ;;
  *)
...
SUITE_SOURCE="${SUITE_SOURCE:-results/thesis_optimization_results/configs/suites/she_vis_rted_style_comparison.yaml}"
