...
def _build_formulation_tradeoff(models: Iterable[str], results_root: Path) -> tuple[pd.DataFrame, list[str]]:
    ...
    out = out.rename(
        columns={
            "objective_dispatch_only": "dispatch_cost",
            "objective_reserve_only": "reserve_cost",
            ...
            rows.append(
                {
                    ...
                    "dispatch_cost": row.get("objective_dispatch_only"),
                    "reserve_cost": row.get("objective_reserve_only"),
