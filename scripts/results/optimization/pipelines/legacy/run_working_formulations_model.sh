...
case "${MODEL_VARIANT}" in
  ...
  mtlsh_all_sched)
    ...
    BASE_CONFIG_SOURCE="${BASE_CONFIG_SOURCE:-configs/scheduling/base_optimization_mtlsh_all_sched.yaml}"
    ;;
  picnn)
    MODEL_TAG="picnn"
    MODEL_LABEL="PICNN"
    BASE_CONFIG_SOURCE="${BASE_CONFIG_SOURCE:-configs/scheduling/base_optimization_picnn.yaml}"
    ;;
  *)
...
FORMULATION_SUITE_SOURCE="${FORMULATION_SUITE_SOURCE:-configs/scheduling/suites/01_formulation_comparison.yaml}"
SECURITY_SUITE_SOURCE="${SECURITY_SUITE_SOURCE:-configs/scheduling/suites/05_security_checks.yaml}"
REDISPATCH_SUITE_SOURCE="${REDISPATCH_SUITE_SOURCE:-configs/scheduling/suites/06_redispatch_sensitivity.yaml}"
ZONE_MISMATCH_SUITE_SOURCE="${ZONE_MISMATCH_SUITE_SOURCE:-configs/scheduling/suites/04_zone_mismatch_vis_sensitivity.yaml}"
REPLAY_CONFIG_SOURCE="${REPLAY_CONFIG_SOURCE:-configs/scheduling/replay/replay_validation.yaml}"
ANALYSIS_CONFIG_SOURCE="${ANALYSIS_CONFIG_SOURCE:-configs/scheduling/analysis/results_pack.yaml}"
...
FORMULATION_SUITE_CONFIG="${GENERATED_CONFIG_DIR}/01_formulation_comparison.yaml"
SECURITY_SUITE_CONFIG="${GENERATED_CONFIG_DIR}/05_security_checks.yaml"
REDISPATCH_SUITE_CONFIG="${GENERATED_CONFIG_DIR}/06_redispatch_sensitivity.yaml"
ZONE_MISMATCH_SUITE_CONFIG="${GENERATED_CONFIG_DIR}/04_zone_mismatch_vis_sensitivity.yaml"
