...
python models/train_sweep.py --config configs/model/scaler_comparison_mlp.yaml
python models/train_sweep.py --config configs/model/scaler_comparison_mtlsh.yaml
python models/train_sweep.py --config configs/model/scaler_comparison_mtlgsh.yaml
python models/train_sweep.py --config configs/model/scaler_comparison_picnn.yaml
